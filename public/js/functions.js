...
//<img loading="lazy" src="'+ URL_BASE +'/img/top.png" class="goTop" />
...
var scrolltotop={
	...
	controlHTML: '<i class="fa fa-arrow-up up-bottom"></i>', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
