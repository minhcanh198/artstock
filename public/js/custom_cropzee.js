...
jQuery.fn.extend({
  cropzee: function (options = {
        ...
        window.cropzeeRotateImage = function(id) {
            ...
            // $("#cropzee-hidden-canvas img").empty();
            cropzeeCroppr.destroy();
            console.log('roateqewqewqew');
            setTimeout(function(){
                ...
                //     console.log(cropzeeCanvasWidth);
                // console.log(-cropzeeCanvasWidth * 0.5);
                // console.log(cropzeeCanvasHeight);
                // console.log(-cropzeeCanvasHeight * 0.5);
                
                
                    console.log('hehrhehrehrehrhe ');
        ...
        window.cropzeeCreateImage = function(id) {
            ...
            if (options.returnImageMode == 'blob') {
                console.log('in blob if condition');
                ...
                var qwe = cropzeeReturnImage[id].split(",")[1];
                console.log('qwe');
                console.log(qwe);
            }
            // cropping finished, close modal
            // $("#filePhoto").trigger("change");
            $("#baseTxtImg").val(cropzeeReturnImage[id]);
            closeModal();
        }
            ...
            '<div class="light-modal" id="cropzee-modal" role="dialog" aria-labelledby="light-modal-label" aria-hidden="false" data-lightmodal="close">'
                + '<div class="light-modal-content ' + animation + '">'
                    ...
                    + '<div class="light-modal-footer" style="justify-content: space-between;">'
                        ...
                        + '<div onclick="cropzeeRotateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer;">Rotate</div>'
