...
;(function ($, window, document, undefined) {
  ...
  var pluginName = "simpleCalendar2",
    defaults = {
  ...
  $.extend(Plugin.prototype, {
    ...
    buildCalendar: function (fromDate, calendar) {
      ...
      // console.log('fromDate ===========> ' + fromDate.getMonth());
      // console.log('asdas ===========> ' + (new Date).getMonth());
      ...
      for (var day = firstDay; day <= lastDay; day.setDate(day.getDate())) {
        ...
        for (var i = 0; i < 7; i++) {
          ...
          // console.log(dayAfterTomorrow2.getDate());
  ...
  "July", "August", "September", "October", "November", "December"
      ...
      $(plugin.element).on('click', '.day', function (e) {
        ...
        // console.log('asd'+date.getDate());
        // console.log('asd'+date.getMonth());
        // console.log('asd'+date.getFullYear());
        ...
        }else if(date.getDate() === dayAfterTomorrow2.getDate())
        {
          ...
          $("#Calender2").hide();
          $('.day').removeClass("selected-custom-date");
          $(this).closest('td').find('.day').addClass("selected-custom-date");
