...
<header>
    <div class="mobile-menu">
        ...
        <div class="nveMenu text-left">
            <div>
                <img loading="lazy" src="{{{ asset('new_template/images/logo.png') }}}" class="img-fluid" loading="lazy">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="social-icons">
                        <ul>
                            <li><img loading="lazy" src="{{{ asset('new_template/images/insta.png') }}}"></li>
                            <li><img loading="lazy" src="{{{ asset('new_template/images/fb.png') }}}"></li>
                            <li><img loading="lazy" src="{{{ asset('new_template/images/twitter.png') }}}"></li>
                            <li><img loading="lazy" src="{{{ asset('new_template/images/whats-app.png') }}}"></li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="logo">
                        ...
                        <div class="social-icons">
                            <ul>
                                <li><a href="#"><img loading="lazy" src="{{{ asset('new_template/images/insta.png') }}}"></a></li>
                                <li><a href="#"><img loading="lazy" src="{{{ asset('new_template/images/fb.png') }}}"></a></li>
                                <li><a href="#"><img loading="lazy" src="{{{ asset('new_template/images/twitter.png') }}}"></a></li>
                                <li><a href="#"><img loading="lazy" src="{{{ asset('new_template/images/whats-app.png') }}}"></a></li>
