    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6" data-aos="fade-left">
                <!-- <div class="banner-img"><img class="img-fluid" src="{{{ asset('public/new_template/images/banner-img2.png') }}}"></div> -->
                    ...
                    <div class="single__tab active recent">
                        <div class="container">
                            ...
                            <div class="row baguetteBoxOne gallery">
                                ...
                                @endphp
                                    @if($i == 0)
                                        <div class="col-md-4" data-aos="fade-right">        
                                            {{-- <div class="box"><a href="{{{ asset('public/new_template/images/img1.jpg') }}}"><img class="img-fluid" src="{{ asset($thumbnail) }}"></a></div> --}}
                                            <div class="box"><a href="{{ url('photo', $image->id ) }}/{{str_slug($image->title)}}"><img class="img-fluid" src="{{ asset($thumbnail) }}"></a></div>
                                        {{-- <div class="box"><a href="{{{ asset('public/new_template/images/img1.jpg') }}}">{{ $item1->id }}</a></div> --}}
                                        </div>
                                    @endif
                                    ...
                                    @if($i==1 || $i == 2)
                                        @if($i == 1)
                                           <div class="col-md-4">
                                               {{-- <div class="box2" data-aos="fade-down"><a href="{{{ asset('public/new_template/images/img2.jpg') }}}"><img class="img-fluid" src="{{ asset($thumbnail) }}"></a></div> --}}
                                        ...
                                        @endif
                                        @if($i == 2)
                                                {{-- <div class="box2" data-aos="fade-up"><a href="{{{ asset('public/new_template/images/img3.jpg') }}}"><img class="img-fluid" src="{{ asset($thumbnail) }}"></a></div> --}}
                                    ...
                                    @if($i == 3)
                                        <div class="col-md-4" data-aos="fade-left">
                                            {{-- <div class="box"><a href="{{{ asset('public/new_template/images/img4.jpg') }}}"><img class="img-fluid" src="{{ asset($thumbnail) }}"></a></div> --}}
                                            <div class="box"><a href="{{ url('photo', $image->id ) }}/{{str_slug($image->title)}}"><img class="img-fluid" src="{{ asset($thumbnail) }}"></a></div>
                                        </div><br>
                                    @endif
                                <?php $i++; ?> 
                                ...
                                {{-- <div class="col-md-4" data-aos="fade-right">
                                    <div class="box"><a href="{{{ asset('public/new_template/images/img5.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img5.jpg') }}}"></a></div>
                                </div>
                                <div class="col-md-4">
                                    <div class="box2" data-aos="fade-down"><a href="{{{ asset('public/new_template/images/img6.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img6.jpg') }}}"></a></div>
                                    <div class="box2" data-aos="fade-up"><a href="{{{ asset('public/new_template/images/img7.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img7.jpg') }}}"></a></div>
                                </div>
                                <div class="col-md-4" data-aos="fade-left">
                                    <div class="box"><a href="{{{ asset('public/new_template/images/img8.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img8.jpg') }}}"></a></div>
                                </div> --}}
                            </div>
                            {{-- @endforeach --}}
                        </div>
                        ...
                        {{-- <div class="single__tab  {{ $category->slug }}"> --}}
                            <div class="container">
                                <div class="row baguetteBoxOne gallery" id="inside-content-{{ $category->slug }}">
                                    ...
                                    {{-- <div class="col-md-4" data-aos="fade-right">
                                        <div class="box"><a href="{{{ asset('public/new_template/images/img1.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img1.jpg') }}}"></a></div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="box2" data-aos="fade-down"><a href="{{{ asset('public/new_template/images/img2.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img2.jpg') }}}"></a></div>
                                        <div class="box2" data-aos="fade-up"><a href="{{{ asset('public/new_template/images/img3.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img3.jpg') }}}"></a></div>
                                    </div>
                                    <div class="col-md-4" data-aos="fade-left">
                                        <div class="box"><a href="{{{ asset('public/new_template/images/img4.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img4.jpg') }}}"></a></div>
                                    </div><br>
                                    <div class="col-md-4" data-aos="fade-right">
                                        <div class="box"><a href="{{{ asset('public/new_template/images/img5.jpg') }}}"><img class="img-fluid" src="{{{ asset('public/new_template/images/img5.jpg') }}}"></a></div>
                                    </div>
...
<div class="row">
    ...
    <div class="inner-img">
        ...
        <!-- <img src="{{{ asset('public/new_template/images/p-1.png') }}}" class="img-fluid"> -->
...
<div class="col-md-7" data-aos="fade-right">
    ...
    <!-- <img src="{{{ asset('public/new_template/images/p-2.png') }}}" class="img-fluid"> -->
...
<div class="row">
    ...
    <div class="inner-img">
    <!-- <img src="{{{ asset('public/new_template/images/p-3.png') }}}" class="img-fluid"> -->
...
<div class="col-md-7 aos-init aos-animate" data-aos="fade-right">
    ...
    <div class="inner-img aos-init aos-animate" data-aos="zoom-in">
        <!-- <img src="{{{ asset('public/new_template/images/p-4.png') }}}" class="img-fluid"> -->
