                        ...
                        <div class="row padding-top-20">
                            <div class="col-sm-12">
                                ...
                                @if($getTypeDetails->type_name == "Photographer")
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 offset-md-2" id="describeSpecificLocationRouteDiv" style="display:none;">
                                            <div class="form-group" >
                                                <label for="tripReason" class="label-form-photo-shoot mb-14">Please describe your route. </label>
                                                <textarea id="txtAreaDescribeRoute" name="describe_specific_location_route" class="form-control" rows="6"  placeholder="" style="height: 110px;"></textarea>
                                            </div>
                                        </div>
                                        <div id="errorDescribeRouteDiv"></div>
                                        <div class="col-md-8 offset-md-2" >
                                            <div class="form-group" id="addressMeetArtistDiv" style="display:none;">
                                                <label for="yourPreferredStyle" class="label-form-photo-shoot mb-14">Please enter the address of where you would like to meet your photographer to start your shoot.</label>
                                ...
                                @elseif($getTypeDetails->type_name == "Videographer")
                                    <div class="row justify-content-center" id="scrollDivRoute">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 offset-md-2" >
                                                <div class="form-group" id="addressMeetArtistDiv" style="display:none;">
                                                    <label for="yourPreferredStyle" class="label-form-photo-shoot mb-14">Please enter the address of where you would like to meet your videographer to start your shoot.</label>
                                                    <textarea class="form-control" id="txtAreaMeetArtist" name="address_meet_artist" rows="6" ></textarea>
                                                </div>
                                                <div id="errorMeetArtistDiv"></div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                    <!--<div class="col-md-8 offset-md-2">-->
                                    <!--    <div class="form-group" id="scrollDivLevelOfDirection">-->
                                    <!--        <label for="tripReason" class="label-form-photo-shoot mb-14">What level of direction would you like from the photographer?</label>-->
