  ...
  <div>
    <div class="row form-group">
        <div class="col-12 mt-4">
            <img class="license-img-new" src="<?php echo url('public/license_page/section_2_content/').'/'.$licensePageSettings->section_2_content_1_image; ?>">      
        ...
        <div class="col-12 mt-4">
            <img class="license-img-new" src="<?php echo url('public/license_page/section_2_content/').'/'.$licensePageSettings->section_2_content_2_image; ?>">   
            <div class="box-div box-div-2">
        ...
        <div class="col-12 mt-4">
            <img class="license-img-new" src="<?php echo url('public/license_page/section_2_content/').'/'.$licensePageSettings->section_2_content_3_image; ?>">   
            <div class="box-div box-div-2">
        ...
        <div class="col-12 mt-4">
            <img class="license-img-new" src="<?php echo url('public/license_page/section_2_content/').'/'.$licensePageSettings->section_2_content_4_image; ?>">   
            <div class="box-div box-div-2">
