							...
							<div class="row no-gutters">
								...
								<div class="col-6 col-md-2 second-search">
									<select class="select22-icon" name="type" id="type">
										...
										?>
											<option value="{{ $categSearchBar->id }}" data-icon="fas {{$categSearchBar->icon_text }}">{{ $categSearchBar->name }}</option>
										<?php
										}
										?>
									</select>
								...
								<div class="col-md-8 col-12 mt-3 mt-md-0">
									<div class="input-group">
										<input type="text" class="form-control mt-0" name="txt_search" placeholder="Search">
				...
				<div id="tabs__content">
					...
					<div class="single__tab  {{ $category->slug }}" id="content-{{ $category->slug }}">
						<div class="container innr-content-{{ $category->slug }} baguetteBoxOne gallery">
							<section id="photos" class="baguetteBoxOne gallery inside-content-{{ $category->slug }}">
							</section>
						</div>
					</div>
					@endforeach
        		                ...
        		                <!--<div class="col-md-4">-->
                                	<div class="choose-photographer-box">
                                		<div class="pt-4 pb-4 pl-3 pr-3">
                                			<div class="">
                                			    <a href="<?php echo url('/')?>/artist/<?php echo $userPhotographer->id; ?>">
                            					    <img src="<?php echo url('/')?>/public/avatar/<?php echo $userPhotographer->avatar; ?>" alt="" class="photographer-thimbnial">
                            					 </a>
                                			    <h4 class="title-this-photographer">{{ $userPhotographer->username }}</h4>
                                                <p class="tag-one-photographer">{{ $userPhotographer->type_name }}</p>
                                                <p class="tag-one-photographer" style="    margin-left: 77px;">{{ $userPhotographer->CountryName }}</p>
                            			...
                            			<div class="bottom" style="background-image: url(https://projects.hexawebstudio.com/darquise-nantel/public/uploads/thumbnail/musicWave.png)">
                            				<div class="">
                            					<div class="d-md-flex">
                            						<a href="<?php echo url('/')?>/artist/<?php echo $userPhotographer->id; ?>" class="btn-portfolio-one w-100 mt-0">Portfolio</a>
                            						<!--&amp;cityId=<?php //echo $userPhotographer->city_id; ?>-->
                            						<a href="<?php echo url('/')?>/request-to-book?photographerId=<?php echo $userPhotographer->id ;?>" class="button-book-one w-100">Book artist</a>
                                	...
                                	<div class="choose-photographer-box">
                                		<div class="pt-4 pb-4 pl-3 pr-3">
                                			<div class="">
                                                ...
                                                <p class="tag-one-photographer" style="    margin-left: 77px;">{{ $userVideographer->CountryName }}</p>
                            			...
                            			<div class="bottom" style="background-image: url(https://projects.hexawebstudio.com/darquise-nantel/public/uploads/thumbnail/musicWave.png)">
                            				<div class="">
                            					<div class="d-md-flex">
                            						<a href="<?php echo url('/')?>/artist/<?php echo $userVideographer->id; ?>" class="btn-portfolio-one w-100 mt-0">Portfolio</a>
                            						<!--&amp;cityId=<?php //echo $userVideographer->city_id; ?>-->
                            						<a href="<?php echo url('/')?>/request-to-book?photographerId=<?php echo $userVideographer->id ;?>" class="button-book-one w-100">Book artist</a>
            		             ...
            		             <!--<div class="col-md-4">-->
                                	<div class="choose-photographer-box">
                            			...
                            			<div class="bottom" style="background-image: url(https://projects.hexawebstudio.com/darquise-nantel/public/uploads/thumbnail/musicWave.png)">
                            				<div class="">
                            					<div class="d-md-flex">
                            						<a href="<?php echo url('/')?>/artist/<?php echo $userAnimator->id; ?>" class="btn-portfolio-one w-100 mt-0">Portfolio</a>
                            						<!--&amp;cityId=<?php //echo $userAnimator->city_id; ?>-->
                            						<a href="<?php echo url('/')?>/request-to-book?photographerId=<?php echo $userAnimator->id ;?>" class="button-book-one w-100">Book artist</a>
            		             ...
            		             <!--<div class="col-md-4">-->
                                	<div class="choose-photographer-box">
                                		<div class="pt-4 pb-1 pl-3 pr-3">
                                			<div class="">
                            					<img src="<?php echo url('/')?>/public/avatar/<?php echo $userMusician->avatar; ?>" alt="" class="photographer-thimbnial">
                            			...
                            			<div class="bottom" style="background-image: url(https://projects.hexawebstudio.com/darquise-nantel/public/uploads/thumbnail/musicWave.png)">
                            				<div class="">
                            					<div class="d-md-flex">
                            						<a href="<?php echo url('/')?>/artist/<?php echo $userMusician->id; ?>" class="btn-portfolio-one w-100 mt-0">Portfolio</a>
                            						<!--&amp;cityId=<?php //echo $userMusician->city_id; ?>-->
                            						<a href="<?php echo url('/')?>/request-to-book?photographerId=<?php echo $userMusician->id ;?>" class="button-book-one w-100">Book artist</a>
