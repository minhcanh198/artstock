...
@section('content')
<!-- <div class="jumbotron md  jumbotron_set jumbotron-cover" style="background-image: {{ url('/') }}/about_page/header_assets/{{ $imprintPageSettings->header_main_image }} !important"> -->
<!-- <div class="bg " style="background-image:url(<?php //echo url('license_page/header_assets/').'/'.$imprintPageSettings->header_main_image; ?>);">
