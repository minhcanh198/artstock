...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4>
                {{ trans('admin.admin') }} <i
                    class="fa fa-angle-right margin-separator"></i> {{ trans('misc.purchases') }} ({{$data->total()}})
            </h4>
                                ...
                                @if( $data->total() !=  0 && $data->count() != 0 )
                                    ...
                                    @foreach( $data as $purchase )
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ $image_url }}" title="{{$image_title}}"
                                                   target="_blank">{{ str_limit($image_title, 25, '...') }} <i
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <form method="POST" action="{{$download_url}}"
                                                          accept-charset="UTF-8" class="displayInline">
                                                        @csrf
