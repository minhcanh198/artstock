      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-header">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{{ url('user/dashboard/packages/videographer-package/update') }}}" enctype="multipart/form-data">
          ...
          @include('errors.errors-forms')
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body" id="divHours" style="<?php echo ($package->hours != '') ? 'display:block' : 'display:none'; ?>">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->hours }}}" id="txtHours" name="videographer_hours" class="form-control" placeholder="{{ 'Hours' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body" id="divMinutes" style="<?php echo ($package->minutes != '') ? 'display:block' : 'display:none'; ?>">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->minutes }}}" id="txtMinutes" name="videographer_minutes" class="form-control" placeholder="{{ 'Minutes' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->price }}}" name="videographer_price" class="form-control" placeholder="{{ 'Price' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">{{ 'Number of Videos' }}</label>
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->number_of_videos }}}" name="number_of_videos" class="form-control" placeholder="{{ 'Number of Videos' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-footer">
                    <a href="{{{ url('user/dashboard/packages/videographer-package') }}}" class="btn btn-default">{{{ trans('admin.cancel') }}}</a>
