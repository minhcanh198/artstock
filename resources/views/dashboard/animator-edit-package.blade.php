      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-header">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{{ url('user/dashboard/packages/animator-package/update') }}}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body" id="divHours" style="<?php echo ($package->hours != '') ? 'display:block' : 'display:none'; ?>">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->hours }}}" id="txtHours" name="animator_hours" class="form-control" placeholder="{{ 'Hours' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body" id="divMinutes" style="<?php echo ($package->minutes != '') ? 'display:block' : 'display:none'; ?>">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->minutes }}}" id="txtMinutes" name="animator_minutes" class="form-control" placeholder="{{ 'Minutes' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->price }}}" name="animator_price" class="form-control" placeholder="{{ 'Price' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $package->number_of_animations }}}" name="number_of_animations" class="form-control" placeholder="{{ 'Number of Animations' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
