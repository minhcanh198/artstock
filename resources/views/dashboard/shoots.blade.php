...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4>
                {{ trans('admin.admin') }} <i
                    class="fa fa-angle-right margin-separator"></i> {{ trans_choice('misc.my_requests', 0) }}
                ({{ count($data) }})
            </h4>
        </section>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                @if( count($data) !=  0 && $data->count() != 0 )
                                    ...
                                    <!--<th class="active">{{ trans('misc.chat') }}</th>-->
                                        <!-- Commented by shahzad Chat -->
                                                    ...
                                                    <ul class="well" style="padding:10px; list-style: none;">
                                                        ...
                                                        @if($shoots->status == "approved")
                                                            <li style="margin-bottom:10px;">
                                                                <a class="btn btn-success btn-sm padding-btn"
                                                                   target="_blank"
                                                                   href="<?php echo url('/user/dashboard/checkout/') . '/' . $shoots->reference_no; ?>">Click
                                                                    To Pay</a>
                                                            </li>
                                                        @endif
                                                        @if($shoots->isCustomerAction == "approved")
                                                            <li style="margin-bottom:10px;">
                                                                <a href="{{ url('user/dashboard/download_all_files', $shoots->reference_no) }}"
                                                                   class="btn btn-success btn-sm padding-btn">Download
                                                                    Files</a>
                                                            </li>
                                                        @endif
                                                        @if($shoots->isCustomerAction == "pending" || $shoots->isCustomerAction == "" && $shoots->isUpload == "1")
                                                            <li style="margin-bottom:10px;">
                                                                <a href="{{ url('user/dashboard/view_all_files', $shoots->reference_no) }}"
                                                                   class="btn btn-success btn-sm padding-btn">View
                                                                    Files</a>
                                                            </li>
                                                        @endif
                                                        <li style="margin-bottom:10px;">
                                                            <a href="{{ url('user/dashboard/my-shoots-details', $shoots->id) }}"
                                                        ...
                                                        <li style="margin-bottom:10px;">
                                                            <start-chat :receiver-id="{{ $shoots->artist_id??null }}"
...
@else
                                            ...
                                            @if($shoots->status == "completed" && $shoots->isReviewGiven == "0")
                                                <td>
                                                    <a href="{{ url('user/dashboard/review', $shoots->id) }}" class=""
                                                       target="_blank">
