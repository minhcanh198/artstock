        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('/') }}"><i
                                class="glyphicon glyphicon-home myicon-right"></i> {{ trans('misc.go_back_site') }}</a>
                    </li>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li @if(Request::is('user/dashboard')) class="active" @endif>
                    <a href="{{ url('user/dashboard') }}"><i class="fa fa-dashboard"></i>
                        <span>{{ trans('admin.dashboard') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('user/dashboard/my-shoots')) class="active" @endif>
                    <a href="{{ url('user/dashboard/my-shoots') }}"><i class="fa fa-list"></i>
                        <span>{{ trans_choice('misc.my_requests',0) }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('user/dashboard/my-bookings')) class="active" @endif>
                    <a href="{{ url('user/dashboard/my-bookings') }}"><i class="fa fa-list"></i>
                        <span>{{ trans_choice('misc.my_clients_requests',0) }}</span></a>
                </li><!-- ./Links -->
            ...
            @if(Auth::user()->role == "admin" || Auth::user()->user_type_id != "0")
                <!-- Links -->
                    <li class="treeview @if( Request::is('user/dashboard/packages') || Request::is('user/dashboard/packages/limits') ) active @endif">
                        <a href="javascript:;"><i class="fa fa-cogs"></i> <span>Packages</span> <i
                                class="fa fa-angle-left pull-right"></i></a>

                        <ul class="treeview-menu">
                            @if(Auth::user()->role == "admin")
                                <li @if(Request::is('user/dashboard/packages/photographer-package')) class="active" @endif>
                                    <a href="{{ url('user/dashboard/packages/photographer-package') }}"><i
                                            class="fa fa-circle-o"></i> Photographer Package</a></li>
                                <li @if(Request::is('user/dashboard/packages/videographer-package')) class="active" @endif>
                                    <a href="{{ url('user/dashboard/packages/videographer-package') }}"><i
                                            class="fa fa-circle-o"></i> Videographer Package</a></li>
                                <li @if(Request::is('user/dashboard/packages/animator-package')) class="active" @endif>
                                    <a href="{{ url('user/dashboard/packages/animator-package') }}"><i
                                            class="fa fa-circle-o"></i> Animator Package</a></li>
                                <li @if(Request::is('user/dashboard/packages/musician-package')) class="active" @endif>
                                    <a href="{{ url('user/dashboard/packages/musician-package') }}"><i
                                            class="fa fa-circle-o"></i> Musician Package</a></li>
                            @else
            ...
            <!-- Links -->
                <li @if(Request::is('user/dashboard/photos')) class="active" @endif>
                    <a href="{{ url('user/dashboard/photos') }}"><i class="fa fa-picture-o"></i>
                        <span>{{ trans_choice('misc.images_plural',0) }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('user/dashboard/sales')) class="active" @endif>
                    <a href="{{ url('user/dashboard/sales') }}"><i class="fa fa-cart-plus"></i>
                        <span>{{ trans('misc.sales') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('user/dashboard/purchases')) class="active" @endif>
                    <a href="{{ url('user/dashboard/purchases') }}"><i
                            class="icon icon-FullShoppingCart myicon-right"></i>
                        <span>{{ trans('misc.my_purchases') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('user/dashboard/deposits')) class="active" @endif>
                    <a href="{{ url('user/dashboard/deposits') }}"><i class="ion ion-cash"></i>
                        <span>{{ trans('misc.deposits_history') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('user/dashboard/withdrawals')) class="active" @endif>
                    <a href="{{ url('user/dashboard/withdrawals') }}"><i class="fa fa-university"></i>
