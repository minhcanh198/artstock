...
.light-modal ::-webkit-scrollbar {
    width: 4px;
}

.light-modal ::-webkit-scrollbar-track {
    background: #fff;
}
.croppr-container {
...
@include('errors.errors-forms')
    ...
    height: 750px;">
            <input hidden type="text" name="baseTxtImg" id="baseTxtImg">
        ...
        <?php $dimensions = explode('x',$settings->min_width_height_image); ?>
          ...
          oFReader.onload = function (e) {
            ...
            image.onload = function() {
                ...
                window.history.pushState({}, '', urlNeew);
                // console.log("ider hu main ");
