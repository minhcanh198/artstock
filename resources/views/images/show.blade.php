        ...
        <dd>
          ...
          case 'vector':
              ...
              break;
    		 	 ...
    		 	 ?>
          <div class="radio margin-bottom-15 @if(Auth::check() && Auth::user()->id == $response->user_id) hide @endif">
        ...
        @else
            ...
            <!--<div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#">Instant Buy</a>
...
/*$(document).ready(function() {
    $('.stripeBtn').on('click', function(event) { $(this).prop("disabled", true);
