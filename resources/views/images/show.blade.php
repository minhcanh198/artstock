...
@section('css')
    ...
    <meta property="og:image:width" content="{{App\Helper::getWidth('uploads/preview/'.$response->preview)}}"/>
    <meta property="og:image:height" content="{{App\Helper::getHeight('uploads/preview/'.$response->preview)}}"/>
...
@section('content')
                            ...
                            <div class="media-left">
                                <a href="{{url($response->user()->username)}}">
                                    <img class="media-object img-circle"
                                         src="{{asset('avatar/'.$response->user()->avatar)}}" width="50" height="50">
                                </a>
                            </div>
                            <div class="media-body">
                            ...
                            <div class="form-group">
                                ...
                                <dd>
                                    @foreach( $stockImages as $stock )
                                        ...
                                        ?>
                                        <div
                                            class="radio margin-bottom-15 @if(Auth::check() && Auth::user()->id == $response->user_id) hide @endif">
            ...
            data-currency="usd">
                                    ...
                                    @if(Auth::check())
                                        ...
                                        <div class="payment-panel-main">
                                            <div class="radio margin-bottom-15 payment-panel-box">
                                                <label class="padding-zero paymentOption" data-type="stripe"
                                                       data-amount="">
                      ...
                      <span class="label label-payment-icon label-default myicon-right"><i
                              class="fab fa-stripe"></i></span>
                                            ...
                                            <div class="radio margin-bottom-15 payment-panel-box">
                                                <label class="padding-zero paymentOption" data-type="paypal"
                                                       data-amount="">
                                                    <input class="no-show" name="payment_option" type="radio"
                                                           value="paypal">
                                                    <span class="input-sm"
                      ...
                      <span class="label label-payment-icon label-default myicon-right"><i class="fab fa-cc-paypal"></i></span>
                                    ...
                                    @endif
                                @else
                                    <div class="panel panel-danger text-center"><span
                                            class="text-danger">{{trans('misc.artist_payment_not_ready')}}</span></div>
                            @endif
    ...
    margin-bottom: 10px;"><i class="icon icon-Drop myicon-right" aria-hidden="true"></i>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><span
                            class="badge data-xs-img">{{$stockImages[2]->resolution}}</span> {{trans('misc.resolution')}}
                    </li>
                    ...
                    <li href="#" class="list-group-item"><span
                            class="badge data-xs-img">{{$stockImages[2]->size}}</span> {{trans('misc.file_size')}}</li>
                </ul>
