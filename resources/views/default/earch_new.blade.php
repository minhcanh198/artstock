                ...
                <div class="filters-head-area row">
                    <div class="col-6 align-self-center" id="filterBtnDiv">
                        <h6 class="toggleFiltersBtn">
                            <img loading="lazy" src="{{ asset('search-page-img/filters.png') }}" alt=""
                                 class="set-filter-icon">
                            <span>Filters</span>
                        </h6>
                    </div>
            ...
            <div class="col-md-10">
                <form action="{{ url('/search') }}" id="formSearch" method="get">
                    ...
                    <input type="hidden" id="sub_category" name="sub_category"
                           value="<?php echo \Request::query('sub_category'); ?>">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-2">
                                <select class="select2-icon" name="by" id="by">
                                    <option
                                        <?php echo (\Request::query('by') == 'by-industry') ? 'selected' : ''; ?> value="by-industry">
                                        By Industry
                                    </option>
                                    <option
                                        <?php echo (\Request::query('by') == 'by-profession') ? 'selected' : ''; ?> value="by-profession">
                                        By Profession
                                    </option>
                                </select>
                            </div>
                            <div class="col-2 second-search">
                                ...
                                <select class="select22-icon" name="type" id="type"
                                        style="<?php echo (\Request::query('type') == null) ? 'display:none;' : 'display:block;' ?>">
                                    <?php } else { ?>
                                    <select class="select22-icon" id="type"
                                            style="<?php echo (\Request::query('type') == null) ? 'display:none;' : 'display:block;' ?>">
                                        <?php } ?>
                                        ...
                                        ?>
                                        <option selected value="{{ $categSearchBar->id }}"
                                                data-icon="fas fa-photo-video">{{ $categSearchBar->name }}</option>
                                        <?php
                                        } else {
                                        ?>
                                    ...
                                    <select class="select222-icon" name="artist" id="artist"
                                            style="<?php echo (\Request::query('artist') == null) ? 'display:none;' : 'display:block' ?>">
                                        <?php } else { ?>
                                        <select class="select222-icon" id="artist"
                                                style="<?php echo (\Request::query('artist') == null) ? 'display:none;' : 'display:block' ?>">
                                            <?php } ?>
                                            <option value="all" data-icon="far fa-images">All</option>
                                            <?php
                                            ...
                                            ?>
                                            <option selected value="{{ $categSearchBar->types_id }}"
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    <input type="text" class="form-control mt-0" name="txt_search" id="txt_search"
                                           placeholder="Search" value="{{ Request::query('txt_search') }}">
            ...
            <div class="col-md-2 border-side-bar p-1" id="sideBarSearch">
                <div class="side-bar">
                    <div class="sort-by-search">
                            ...
                            <div class="card">
                                <div class="card-header" id="faqhead1">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                                       data-target="#faq1" aria-expanded="true" aria-controls="faq1">Sort by</a>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="sort-by-ul" style="column-count: 2;">
                                            <li class="mb-2">
                                                ...
                                                <input type="button" name="sortOption" id="sortOption-Downloaded"
                                                       class="btn-sort-by-search <?php echo (\Request::query('sort') == "Downloaded") ? 'active' : ''; ?>"
                                                       value="Downloaded">
                                            </li>
                                            <li class="mb-2 ">
                                                ...
                                                <input type="button" name="sortOption" id="sortOption-Fresh"
                                                       class="btn-sort-by-search <?php echo (\Request::query('sort') == "Fresh") ? 'active' : ''; ?>"
                                                       value="Fresh">
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="accordion" id="faq22Type"
                             style="<?php echo (\Request::query('type') != null) ? 'display:block;' : 'display:none;' ?>">
                            <div class="card">
                                <div class="card-header" id="faqhead2">
                                    <a href="#" class="btn btn-header-link collapsed " data-toggle="collapse"
                                       data-target="#faq2" aria-expanded="true" aria-controls="faq2">Type</a>
                                </div>
                                ...
                                <div id="faq2" class="collapse show" aria-labelledby="faqhead2" data-parent="#faq22">
                                    <div class="card-body">
                                        <ul class="sort-by-ul" style="column-count: 2;">
                                            ...
                                            <li class="mb-2 ">
                                                <button id="btnType-{{ $categ->id }}" class="btn-sort-by-search active">
                                                    {{ $categ->name }}
                                                </button>
                                            </li>
                                            <?php
                                            ...
                                            ?>
                                            <li class="mb-2 ">
                                                <button id="btnType-{{ $categ->id }}" class="btn-sort-by-search ">
                                                    {{ $categ->name }}
                                                </button>
                                            </li>
                                        <?php
                        ...
                        <div class="accordion" id="faq33Artist"
                             style="<?php echo (\Request::query('artist') != null) ? 'display:block;' : 'display:none;' ?>">
                            <div class="card">
                                <div class="card-header" id="faqhead3">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                                       data-target="#faq3" aria-expanded="true" aria-controls="faq3">Artist</a>
                                </div>
                                ...
                                <div id="faq3" class="collapse show" aria-labelledby="faqhead3" data-parent="#faq33">
                                    <div class="card-body">
                                        <ul class="sort-by-ul" style="column-count: 2;">
                                            ...
                                            <li class="mb-2">
                                                <button id="btnArtist-{{ $type->types_id }}"
                                                        class="btn-sort-by-search active">
                                                    {{ $type->type_name }}
                                                </button>
                                            </li>
                                            <?php
                        ...
                        <div class="accordion" id="faq44">
                            <div class="card">
                                <div class="card-header" id="faqhead4">
                                    <a href="#" class="btn btn-header-link collapsed " data-toggle="collapse"
                                       data-target="#faq4" aria-expanded="true" aria-controls="faq4">Sub Category</a>
                                </div>

                                <div id="faq4" class="collapse show" aria-labelledby="faqhead4" data-parent="#faq44">
                                    <div class="card-body">
                                        <select class="select2-icon2" name="select_sub_category"
                                ...
                                @if($image->is_type == "video")
                                    <div class="box">
                                        <a href="{{ url('video', $image->id ) }}/{{str_slug($image->title)}}">
                                            <video onmouseover="this.play()" onmouseout="this.pause()" width="320"
                                                   height="240" muted loop>
                                ...
                                @else
                                    <div class="box">
                                        <a href="{{ url('photo', $image->id ) }}/{{str_slug($image->title)}}"><img
                                                loading="lazy" class="img-fluid" src="{{ asset($thumbnail) }}"></a>
                                    </div>
                                @endif
                            @endforeach
                        </section>
