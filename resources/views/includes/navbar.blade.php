      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="{{ url('/') }}">
          	<img loading="lazy" src="{{ asset('img/logo.png') }}" class="logo" />
          	</a>
        </div><!-- navbar-header -->
        ...
        <div class="navbar-collapse collapse">
        	...
        	<ul class="nav navbar-nav navbar-right margin-bottom-zero">
        		 ...
        		 <li>
        			<a href="{{url('photos/premium')}}" class="font-default text-uppercase">
        				{{trans('misc.premium')}}
        				</a>
        		</li>
					@endif
        		...
        		@if( Auth::check() )
        			...
        			<li class="dropdown">
			          <a href="javascript:void(0);" data-toggle="dropdown" class="userAvatar myprofile dropdown-toggle font-default text-uppercase">
			          		<img loading="lazy" src="{{ asset('avatar').'/'.$userAuth->avatar }}" alt="User" class="img-circle avatarUser" width="21" height="21">
