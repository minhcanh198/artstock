      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{{ url('panel/admin/destinations/cities/add') }}}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ old('city_name') }}}" name="city_name" class="form-control" placeholder="{{ 'City Name' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                      	...
                      	<textarea name="city_description" rows="5" cols="40" id="content" class="form-control" placeholder="{{ trans('admin.content') }}">{{{ old('description') }}}</textarea>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <label class="padding-zero">
                          <input type="radio" name="city_status" value="1" checked>
                          {{{ trans('admin.active') }}}
                        </label>
                      </div>
                      ...
                      <div class="radio">
                        <label class="padding-zero">
                          <input type="radio" name="city_status" value="0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!-- <div class="btn-block margin-bottom-10">
                                <img src="{{url('/public/img_city/')}}" style="width:150px">
                            </div> -->
