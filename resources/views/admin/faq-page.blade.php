		...
		@endif
        	...
        	<div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Faq Page Settings</h3>
                </div><!-- /.box-header -->

                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/faq-page-settings') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($faqPageSettings->header_main_image != null)
                          <img src="{{url('/public/faq_page/header_assets/').'/'. $faqPageSettings->header_main_image }}" style="width:200px">
                        @endif
                        </div>
