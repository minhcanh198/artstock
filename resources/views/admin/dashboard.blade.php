<?php
  ...
  $images       = App\Models\Images::where('is_type','=','image')->orderBy('id','DESC')->take(5)->get();
  $videos       = App\Models\Images::where('is_type','=','video')->orderBy('id','DESC')->take(5)->get();
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            case 'pending':
              ...
              <div class="box-footer text-center">
                <a href="{{ url('panel/admin/videos') }}" class="uppercase">{{ trans('admin.view_all_videos') }}</a>
              </div><!-- /.box-footer -->
