...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h4>
           {{ trans('admin.admin') }} <i class="fa fa-angle-right margin-separator"></i> {{ trans_choice('misc.approved_requests', 0) }} ({{ count($data) }})
          </h4>
        </section>
              ...
              <div class="box">
               ...
               <tbody>
                  ...
                  @foreach( $data as $shoots )
                   ...
                   <a href="{{ url('panel/admin/booking-approved-details', $shoots->id) }}" class="btn btn-success btn-sm padding-btn" target="_blank">
