       ...
       <div class="row">
       	...
       	<div class="col-md-9">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/videos/update') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-footer">
                  	 <a href="{{ url('panel/admin/videos') }}" class="btn btn-default">{{ trans('admin.cancel') }}</a>
        ...
        <div class="col-md-3">
        	...
        	<div class="block-block text-center">
                ...
                ?>
        		<img src="{{ asset('public/uploads/video/screen_shot/').'/screen-shot-'.$explodeVideoThumbnail }}" class="thumbnail img-responsive">
        	</div>
