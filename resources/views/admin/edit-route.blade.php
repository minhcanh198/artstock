      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{{ url('panel/admin/destinations/routes/update') }}}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $routes->route_name }}}" name="route_name" class="form-control" placeholder="{{ 'Route Name' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ $routes->route_tagline }}}" name="route_tagline" class="form-control" placeholder="{{ 'Route Tagline' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                            ...
                            <div class="col-sm-10">
                                <select name="state_id" id="state_id" class="form-control">
                                    ...
                                    @foreach($state as $dataState)
                                        @if($dataState->id == $routes->state_id)
                            ...
                            <div class="col-sm-10">
                                <select name="city_id" id="city_id" class="form-control">
                                    ...
                                    @foreach($city as $dataCity)
                                        @if($dataCity->id == $routes->city_id)
                                            <option selected value="{{ $dataCity->id }}">{{ $dataCity->city_name }}</option>
                                        @else
                                            <option value="{{ $dataCity->id }}">{{ $dataCity->city_name }}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                      	...
                      	<textarea name="route_description" rows="5" cols="40" id="content" class="form-control" placeholder="{{ trans('admin.content') }}">{{ $routes->description }}</textarea>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <label class="padding-zero">
                          <input type="radio" name="route_status" value="1" @if( $routes->is_active == '1' ) checked @endif>
                          {{{ trans('admin.active') }}}
                        </label>
                      </div>
                      ...
                      <div class="radio">
                        <label class="padding-zero">
                          <input type="radio" name="route_status" value="0" @if( $routes->is_active == '0' ) checked @endif>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="btn-block margin-bottom-10">
                                <img loading="lazy" src="{{url('/img-route/').'/' . $routes->route_img}}" style="width:150px">
                            </div>
