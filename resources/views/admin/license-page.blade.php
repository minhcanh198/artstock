                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($licensePageSettings->header_main_image != null)
                          <img loading="lazy" src="{{url('/license_page/header_assets/').'/'. $licensePageSettings->header_main_image }}" style="width:200px">
                        @endif
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($licensePageSettings->section_2_content_1_image != null)
                          <img loading="lazy" src="{{url('/license_page/section_2_content/').'/'. $licensePageSettings->section_2_content_1_image }}" style="width:200px">
                        @endif
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($licensePageSettings->section_2_content_2_image != null)
                          <img loading="lazy" src="{{url('/license_page/section_2_content/').'/'. $licensePageSettings->section_2_content_2_image }}" style="width:200px">
                        @endif
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($licensePageSettings->section_2_content_3_image != null)
                          <img loading="lazy" src="{{url('/license_page/section_2_content/').'/'. $licensePageSettings->section_2_content_3_image }}" style="width:200px">
                        @endif
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($licensePageSettings->section_2_content_4_image != null)
                          <img loading="lazy" src="{{url('/license_page/section_2_content/').'/'. $licensePageSettings->section_2_content_4_image }}" style="width:200px">
                        @endif
                        </div>
