		...
		@endif
        	...
        	<div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Terms and Conditions Page Settings</h3>
                </div><!-- /.box-header -->

                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/terms-page-settings') }}" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                      <textarea id="basic-example" name="content" placeholder="Terms and Conditions Page Content">{{ $termsPageSettings->content }}</textarea>
