      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{{ url('panel/admin/package/add') }}}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  <div class="box-body" id="divHours" style="display:none;">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ old('name') }}}" id="txtHours" name="hours" class="form-control" placeholder="{{ 'Hours' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body" id="divMinutes" style="display:none;">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ old('name') }}}" id="txtMinutes" name="minutes" class="form-control" placeholder="{{ 'Minutes' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ old('name') }}}" name="price" class="form-control" placeholder="{{ 'Price of package' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                   ...
                   <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{{ old('name') }}}" name="number_of_photos" class="form-control" placeholder="{{ 'Number of Photos' }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
                  ...
                  <div class="box-footer">
                    <a href="{{{ url('panel/admin/package') }}}" class="btn btn-default">{{{ trans('admin.cancel') }}}</a>
