		...
		@endif
        	...
        	<div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Imprint Page Settings</h3>
                </div><!-- /.box-header -->

                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/imprint-page-settings') }}" enctype="multipart/form-data">
