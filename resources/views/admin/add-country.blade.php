      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="box box-danger">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{{ url('panel/admin/destinations/countries/add') }}}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{{ old('country_name') }}}" name="country_name" class="form-control" placeholder="{{{ 'Country Name' }}}">
                        </div>
                        </div>
                    </div><!-- /.box-body -->
