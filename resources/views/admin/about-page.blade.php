		...
		@endif
        	...
        	<div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">About Page Settings</h3>
                </div><!-- /.box-header -->

                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/about-page-settings') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        @if($aboutPageSettings->header_main_image != null)
                          <img loading="lazy" src="{{url('/about_page/header_assets/').'/'. $aboutPageSettings->header_main_image }}" style="width:200px">
                        @endif
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <!-- <label class="col-sm-2 control-label">{{ trans('admin.name_site') }}</label> -->
                      <label class="col-sm-2 control-label">Section 4 Header</label>
                      <div class="col-sm-10">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <!-- <label class="col-sm-2 control-label">{{ trans('admin.name_site') }}</label> -->
                      <label class="col-sm-2 control-label">Section 4 Description</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group">
                      <!-- <label class="col-sm-2 control-label">{{ trans('admin.name_site') }}</label> -->
                      <label class="col-sm-2 control-label">Section 5 Header</label>
                      <div class="col-sm-10">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <!-- <label class="col-sm-2 control-label">{{ trans('admin.name_site') }}</label> -->
                      <label class="col-sm-2 control-label">Section 5 Description</label>
                      <div class="col-sm-10">
