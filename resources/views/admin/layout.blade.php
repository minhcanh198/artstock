    ...
    padding: 2px 7px 2px 7px;" id="spanMessageCounter">0</span></a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img loading="lazy" src="{{ asset('avatar').'/'.Auth::user()->avatar }}" class="user-image"
                                 alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img loading="lazy" src="{{ asset('avatar').'/'.Auth::user()->avatar }}"
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url( Auth::user()->username ) }}"
                                       class="btn btn-default btn-flat">{{ trans('users.my_profile') }}</a>
                                </div>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img loading="lazy" src="{{ asset('avatar').'/'.Auth::user()->avatar }}" class="img-circle"
                         alt="User Image"/>
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li @if(Request::is('panel/admin')) class="active" @endif>
                    <a href="{{ url('panel/admin') }}"><i class="fa fa-dashboard"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li @if(Request::is('panel/admin/settings/limits')) class="active" @endif><a
                                href="{{ url('panel/admin/settings/limits') }}"><i
                                    class="fa fa-circle-o"></i> {{ trans('admin.limits') }}</a></li>
                    </ul>
                ...
                <!-- Links -->
                <li class="treeview @if( Request::is('panel/admin/settings') || Request::is('panel/admin/settings/limits') ) active @endif">
                    <a href="{{ url('panel/admin/settings') }}"><i class="fa fa-cogs"></i> <span>Site Content</span> <i
                            class="fa fa-angle-left pull-right"></i></a>

                    <ul class="treeview-menu">
                        <li @if(Request::is('panel/admin/home-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/home-page-settings') }}"><i class="fa fa-circle-o"></i> Home
                                Page</a></li>
                        <li @if(Request::is('panel/admin/about-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/about-page-settings') }}"><i class="fa fa-circle-o"></i> About
                                Us Page</a></li>
                        <li @if(Request::is('panel/admin/license-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/license-page-settings') }}"><i class="fa fa-circle-o"></i>
                                License Page</a></li>
                        <li @if(Request::is('panel/admin/use-guide-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/use-guide-page-settings') }}"><i class="fa fa-circle-o"></i>
                                Use Guide Page</a></li>
                        <li @if(Request::is('panel/admin/faq-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/faq-page-settings') }}"><i class="fa fa-circle-o"></i> FAQ
                                Page</a></li>
                        <li @if(Request::is('panel/admin/imprint-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/imprint-page-settings') }}"><i class="fa fa-circle-o"></i>
                                Imprint Page</a></li>
                        <li @if(Request::is('panel/admin/privacy-policy-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/privacy-policy-page-settings') }}"><i
                                    class="fa fa-circle-o"></i> Privacy Policy Page</a></li>
                        <li @if(Request::is('panel/admin/terms-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/terms-page-settings') }}"><i class="fa fa-circle-o"></i> Terms
                                & Conditions Page</a></li>
                        <li @if(Request::is('panel/admin/destination-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/destination-page-settings') }}"><i class="fa fa-circle-o"></i>
                                Destination Page</a></li>
                        <li @if(Request::is('panel/admin/destination-page-settings')) class="active" @endif><a
                                href="{{ url('panel/admin/suggest-city-page-settings') }}"><i
                                    class="fa fa-circle-o"></i> Request Suggest City Page</a></li>
                ...
                <!-- Links -->
                <li class="treeview @if( Request::is('panel/admin/settings') || Request::is('panel/admin/settings/limits') ) active @endif">
                    <a href="{{ url('panel/admin/settings') }}"><i class="fa fa-houzz"></i> <span>Inventory</span> <i
                            class="fa fa-angle-left pull-right"></i></a>

                    <ul class="treeview-menu">
                        <li @if(Request::is('panel/admin/music-type')) class="active" @endif><a
                                href="{{ url('panel/admin/music-type') }}"><i class="fa fa-circle-o"></i> Music Type</a>
                        </li>
                        <li @if(Request::is('panel/admin/music-sub-type')) class="active" @endif><a
                                href="{{ url('panel/admin/music-sub-type') }}"><i class="fa fa-circle-o"></i> Music Sub
                                Type</a></li>
                        <li @if(Request::is('panel/admin/photoshoot-type')) class="active" @endif><a
                                href="{{ url('panel/admin/photoshoot-type') }}"><i class="fa fa-circle-o"></i>
                                Photoshoot Type</a></li>
                        <li @if(Request::is('panel/admin/time-day')) class="active" @endif><a
                                href="{{ url('panel/admin/time-day') }}"><i class="fa fa-circle-o"></i> Time Of Day</a>
                        </li>
                        <li @if(Request::is('panel/admin/trip-reason')) class="active" @endif><a
                                href="{{ url('panel/admin/trip-reason') }}"><i class="fa fa-circle-o"></i> Trip
                                Reason</a></li>
                        ...
                        <li @if(Request::is('panel/admin/preferred-style-photo')) class="active" @endif><a
                                href="{{ url('panel/admin/preferred-style-photo') }}"><i class="fa fa-circle-o"></i>
                                Preferred Style Photo</a></li>
                        <li @if(Request::is('panel/admin/level-of-direction')) class="active" @endif><a
                                href="{{ url('panel/admin/level-of-direction') }}"><i class="fa fa-circle-o"></i> Level
                                Of Direction</a></li>
                    </ul>
                ...
                <li class="treeview @if( Request::is('panel/admin/destinations') || Request::is('panel/admin/settings/limits') ) active @endif">
                    <a href="{{ url('panel/admin/destinations') }}"><i class="fa fa-globe"></i>
                        <span>Destinations</span> <i class="fa fa-angle-left pull-right"></i></a>

                    <ul class="treeview-menu">
                        <li @if(Request::is('panel/admin/destinations/continents')) class="active" @endif><a
                                href="{{ url('panel/admin/destinations/continents') }}"><i class="fa fa-circle-o"></i>
                                Continents</a></li>
                        <li @if(Request::is('panel/admin/destinations/countries')) class="active" @endif><a
                                href="{{ url('panel/admin/destinations/countries') }}"><i class="fa fa-circle-o"></i>
                                Countries</a></li>
                    <!-- <li @if(Request::is('panel/admin/destinations/states')) class="active" @endif><a href="{{ url('panel/admin/destinations/states') }}"><i class="fa fa-circle-o"></i> States</a></li> -->
                        <li @if(Request::is('panel/admin/destinations/cities')) class="active" @endif><a
                                href="{{ url('panel/admin/destinations/cities') }}"><i class="fa fa-circle-o"></i>
                                Cities</a></li>
                        <li @if(Request::is('panel/admin/destinations/routes')) class="active" @endif><a
                                href="{{ url('panel/admin/destinations/routes') }}"><i class="fa fa-circle-o"></i>
                                Routes</a></li>
                    </ul>
                ...
                <li class="treeview @if( Request::is('panel/admin/booking-request') || Request::is('panel/admin/settings/limits') ) active @endif">
                    <a href="{{ url('panel/admin/booking-request') }}"><i class="fa fa-search"></i> <span>Booking Requests</span>
                        <i class="fa fa-angle-left pull-right"></i></a>

                    <ul class="treeview-menu">
                        <li @if(Request::is('panel/admin/booking-requests/pending')) class="active" @endif><a
                                href="{{ url('panel/admin/booking-requests/pending') }}"><i class="fa fa-circle-o"></i>
                                Pending Requests</a></li>
                        <li @if(Request::is('panel/admin/booking-requests/rejected')) class="active" @endif><a
                                href="{{ url('panel/admin/booking-requests/rejected') }}"><i class="fa fa-circle-o"></i>
                                Rejected Requests</a></li>
                        <li @if(Request::is('panel/admin/booking-requests/cancelled')) class="active" @endif><a
                                href="{{ url('panel/admin/booking-requests/cancelled') }}"><i
                                    class="fa fa-circle-o"></i> Cancelled Requests</a></li>
                        <li @if(Request::is('panel/admin/booking-requests/approved')) class="active" @endif><a
                                href="{{ url('panel/admin/booking-requests/approved') }}"><i class="fa fa-circle-o"></i>
                                Approved Requests</a></li>
                        <li @if(Request::is('panel/admin/booking-requests/completed')) class="active" @endif><a
                                href="{{ url('panel/admin/booking-requests/completed') }}"><i
                                    class="fa fa-circle-o"></i> Completed Requests</a></li>
                    </ul>
                ...
                <li @if(Request::is('panel/admin/request-suggest-country-city')) class="active" @endif>
                    <a href="{{ url('panel/admin/request-suggest-country-city') }}"><i class="fa fa-calendar"></i>
                        <span>{{ trans('admin.request_of_suggest') }}</span></a>
                </li><!-- ./Links -->


                <!-- Links -->
                <li @if(Request::is('panel/admin/booking-calendar')) class="active" @endif>
                    <a href="{{ url('panel/admin/booking-calendar') }}"><i class="fa fa-calendar"></i>
                        <span>{{ trans('admin.booking_calendar') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('panel/admin/theme')) class="active" @endif>
                    <a href="{{ url('panel/admin/theme') }}"><i class="fa fa-paint-brush"></i>
                        <span>{{ trans('misc.theme') }}</span></a>
                </li><!-- ./Links -->
                ...
                <li @if(Request::is('panel/admin/images')) class="active" @endif>
                    <a href="{{ url('panel/admin/images') }}"><i class="fa fa-picture-o"></i>
                        <span>{{ trans_choice('misc.images_plural',0) }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('panel/admin/purchases')) class="active" @endif>
                    <a href="{{ url('panel/admin/purchases') }}"><i class="fa fa-cart-plus"></i>
                        <span>{{ trans('misc.purchases') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('panel/admin/deposits')) class="active" @endif>
                    <a href="{{ url('panel/admin/deposits') }}"><i class="ion ion-cash"></i>
                        <span>{{ trans('misc.deposits') }}</span></a>
                </li><!-- ./Links -->
                ...
                <li @if(Request::is('panel/admin/faq-categories')) class="active" @endif>
                    <a href="{{ url('panel/admin/faq-categories') }}"><i class="fa fa-list-ul"></i>
                ...
                <li @if(Request::is('panel/admin/sub-categories')) class="active" @endif>
                    <a href="{{ url('panel/admin/sub-categories') }}"><i class="fa fa-list-ul"></i>
                        <span>{{ trans('admin.subcategories') }}</span></a>
                </li><!-- ./Links -->
                ...
                <li @if(Request::is('panel/admin/member_types')) class="active" @endif>
                    <a href="{{ url('panel/admin/member_types') }}"><i class="glyphicon glyphicon-user"></i>
                        <span>{{ trans('admin.member_types') }}</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('panel/admin/members-reported')) class="active" @endif>
                    <a href="{{ url('panel/admin/members-reported') }}"><i class="glyphicon glyphicon-ban-circle"></i>
                        <span>{{ trans('admin.members_reported') }} @if( App\Models\UsersReported::count() <> 0 ) <span
                                class="label label-danger label-admin">{{App\Models\UsersReported::count()}}</span> @endif</span></a>
                </li><!-- ./Links -->

                <!-- Links -->
                <li @if(Request::is('panel/admin/images-reported')) class="active" @endif>
                    <a href="{{ url('panel/admin/images-reported') }}"><i class="glyphicon glyphicon-flag"></i>
                        <span>{{ trans('admin.images_reported') }} @if( App\Models\ImagesReported::count() <> 0 ) <span
                                class="label label-danger label-admin">{{App\Models\ImagesReported::count()}}</span> @endif</span></a>
                </li><!-- ./Links -->
                ...
                <li class="treeview @if(Request::is('panel/admin/payments') || Request::is('panel/admin/payments/*')) active @endif">
                    <a href="{{ url('panel/admin/payments') }}"><i class="fa fa-credit-card"></i>
                        <span>{{ trans('misc.payment_settings') }}</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li @if(Request::is('panel/admin/payments/'.$key->id)) class="active" @endif><a
                                href="{{ url('panel/admin/payments/'.$key->id) }}"><i
                                    class="fa fa-circle-o"></i> {{ $key->name }}</a></li>
                        <?php
                        }
                        ?>
                    </ul>
...
<div class="modal fade" id="messageMainModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
     aria-labelledby="messageMainModalLabel" aria-hidden="true">
...
<!--Modal single chat  -->
<div class="modal fade" id="messageMainModal2" data-backdrop="static" data-keyboard="false" tabindex="-1"
     aria-labelledby="messageMainModal2Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="">
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-sm-1" style="">
                    <button id="sendMsgChat" class="enter-chat"><img loading="lazy" src="{{ url('/') }}/img/email.png"
                                                                     alt="" class="img-responsive" style="width: 17px;">
                    </button>
                </div>
                <div class="col-sm-1"></div>
            </div>
